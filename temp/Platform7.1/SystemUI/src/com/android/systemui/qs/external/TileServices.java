...
public class TileServices extends IQSService.Stub {
    ...
    @Override
    public void updateStatusIcon(IBinder token/*Tile tile*/, Icon icon, String contentDescription) {
	...
	@Override
	public Tile getTile(IBinder token) throws RemoteException {
	...
	@Override
	public void onDialogHidden(IBinder token) throws RemoteException {
		// TODO Auto-generated method stub
		CustomTile customTile = getTileForToken(token);
        if (customTile != null) {
            verifyCaller(customTile);
	...
	@Override
	public void onShowDialog(IBinder token) throws RemoteException {
		// TODO Auto-generated method stub
		CustomTile customTile = getTileForToken(token);
        if (customTile != null) {
            verifyCaller(customTile);
	...
	@Override
	public void onStartActivity(IBinder token) throws RemoteException {
		// TODO Auto-generated method stub
		CustomTile customTile = getTileForToken(token);
        if (customTile != null) {
            verifyCaller(customTile);
	...
	@Override
	public void onStartSuccessful(IBinder token) throws RemoteException {
		// TODO Auto-generated method stub
		CustomTile customTile = getTileForToken(token);
        if (customTile != null) {
            verifyCaller(customTile);
	...
	@Override
	public void startUnlockAndRun(IBinder token) throws RemoteException {
		// TODO Auto-generated method stub
		CustomTile customTile = getTileForToken(token);
        if (customTile != null) {
            verifyCaller(customTile);
	...
	@Override
	public void updateQsTile(Tile tile, IBinder token) throws RemoteException {
		// TODO Auto-generated method stub
		CustomTile customTile = getTileForToken(token);
        if (customTile != null) {
            verifyCaller(customTile);
