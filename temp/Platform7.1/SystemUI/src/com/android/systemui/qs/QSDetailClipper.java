...
public class QSDetailClipper {
    ...
    public void animateCircularClip(int x, int y, boolean in, AnimatorListener listener) {
        ...
        if (in) {
            if(mBackground != null)mBackground.startTransition((int)(mAnimator.getDuration() * 0.6));
    ...
    private final Runnable mReverseBackground = new Runnable() {
        ...
        public void run() {
            if (mAnimator != null) {
            	if(mBackground != null)mBackground.reverseTransition((int)(mAnimator.getDuration() * 0.35));
            }
        }
    };
    ...
    private final AnimatorListenerAdapter mGoneOnEnd = new AnimatorListenerAdapter() {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if(mBackground != null)mBackground.resetTransition();
            mAnimator = null;
        };
    };
}
