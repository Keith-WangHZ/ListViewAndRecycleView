...
public class BrightnessController extends BroadcastReceiver implements ToggleSlider.Listener {
    ...
    public BrightnessController(Context context, ImageView icon, ToggleSlider control,
        ...
        um = (UserManager) mContext.getSystemService(Context.USER_SERVICE);
        ...
        mSwitch = switchBtn;
        mSwitch.setOnCheckedChangeListener(new OnCheckedChangeListenerImp());

		boolean autoValied = mContext
				.getResources()
				.getBoolean(
						com.android.internal.R.bool.config_automatic_brightness_available);
		if (!autoValied) {
    ...
    private class OnCheckedChangeListenerImp implements CompoundButton.OnCheckedChangeListener {  
        @Override  
        public void onCheckedChanged(CompoundButton buttonView,  
			...
			if(isChecked){
		        	   ...
		        	   Settings.System.putIntForUser(mContext.getContentResolver(),Settings.System.SCREEN_BRIGHTNESS_MODE,
								                               Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC,user.id);	
	                }
            } else {
            	 for (UserInfo user : um.getUsers()) {
            	     Settings.System.putIntForUser(mContext.getContentResolver(),Settings.System.SCREEN_BRIGHTNESS_MODE,
            			                           Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL,user.id);	
            	 }
            }
	...
	private void onBrightnessChange(Boolean mAutomatic) {
		if (mAutomatic) {
			if(mSwitch!=null){
    ...
    public void unregisterReceiverCallback(){
...
//        if (mIcon != null) {
        	LogHelper.sd(TAG,"automatic="+automatic+" SHOW_AUTOMATIC_ICON="+SHOW_AUTOMATIC_ICON);
...
//        }
	...
	public void onReceive(Context context, Intent intent) {
	 ...
	 if (action.equals(Intent.ACTION_CONFIGURATION_CHANGED)) {
		 ...
		 if(mSwitch != null){
			 mSwitch.setText(R.string.brightness_dlg_auto);
			}
	 }
	}
