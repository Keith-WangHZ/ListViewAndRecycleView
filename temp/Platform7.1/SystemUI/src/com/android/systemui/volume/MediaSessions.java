    ...
    protected String getControllerName(MediaController controller) {
        ...
        try {
            if (USE_SERVICE_LABEL) {
                final List<ResolveInfo> ris = mPm.queryIntentServices(
                    ...
                    for (ResolveInfo ri : ris) {
                        ...
                        if (pkg.equals(ri.serviceInfo.packageName)) {
                            final String serviceLabel =
                                    Objects.toString(ri.serviceInfo.loadLabel(mPm), "").trim();
            ...
            final String appLabel = Objects.toString(ai.loadLabel(mPm), "").trim();
