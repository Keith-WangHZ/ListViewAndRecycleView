 ...
 */
@RemoteView
public class QsHeaderTextClock extends TextView {
    private static final String TAG = QsHeaderTextClock.class.getSimpleName();
    /**
    ...
    public QsHeaderTextClock(Context context) {
        super(context);
        init();
    }
     ...
     */
    @SuppressWarnings("UnusedDeclaration")
    public QsHeaderTextClock(Context context, AttributeSet attrs) {
     ...
     */
    public QsHeaderTextClock(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public QsHeaderTextClock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//		}
	...
	private String clockView12;
	private String clockView24;
...
//        setContentDescription(s2);
    ...
    public void changeTimeFormat() {
		...
		if (getResources().getConfiguration().locale.getCountry().equalsIgnoreCase("CN")
				|| getResources().getConfiguration().locale.getCountry().equalsIgnoreCase("TW")
				|| getResources().getConfiguration().locale.getCountry().equalsIgnoreCase("HK")) {
			if (!clockView12Skel.contains("a")) {
				mFormat12 = mFormat12.toString().replaceAll("a", "").trim();
			}
			mFormat12 = "a" + mFormat12;
		} else {
			if (!clockView12Skel.contains("a")) {
				mFormat12 = mFormat12.toString().replaceAll("a", "").trim();
			}
