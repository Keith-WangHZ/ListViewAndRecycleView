...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSideKeyguard;
    ...
    public void init() {
        ...
        mLeftSideKeyguard = mView.findViewById(R.id.notification_icon_area_keyguard);
    ...
    private void applyMode(int mode, boolean animate) {
        if (mLeftSide == null || mLeftSideKeyguard == null) return; // pre-init
        ...
        if (animate) {
            ...
            anims.playTogether(
            		animateTransitionTo(mLeftSideKeyguard, newAlpha),
            ...
            if(mLeftSideKeyguard != null){
            	mLeftSideKeyguard.setAlpha(newAlpha);
            }
