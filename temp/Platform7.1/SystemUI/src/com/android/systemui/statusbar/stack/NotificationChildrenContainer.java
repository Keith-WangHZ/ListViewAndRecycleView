...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if(child != null){
            	child.setBackgroundColor(getResources().getColor(R.color.notify_content_background_color, null));
        	}
    ...
    public void recreateNotificationHeader(OnClickListener listener, StatusBarNotification notification) {
        ...
        if (mNotificationHeader == null) {
            ...
            setNotificationTemplateIconStyle(mNotificationHeader, notification);
...
//    		contentView.setBackground(null);
    		contentView.setBackgroundColor(getResources().getColor(R.color.notify_content_background_color, null));
    	}
    	if(contentView == null || sbn == null){
    		return;
    	}
    ...
    public void setChildrenExpanded(boolean childrenExpanded) {
        ...
        if(mNotificationParent != null && !mChildrenExpanded){
        	mNotificationParent.setBackgroundColor(SystemUIApplication.getContext().getResources().getColor(R.color.notify_content_background_color, null));
    	}else if(mNotificationParent != null){
    		mNotificationParent.setBackground(null);
    	}
        updateExpansionStates();
        if (mNotificationHeader != null) {
