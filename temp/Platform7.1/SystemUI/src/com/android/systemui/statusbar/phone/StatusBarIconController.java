...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    private SignalClusterViewYuLong mSignalCluster;
    private SignalClusterViewYuLong mSignalClusterKeyguard;
    private LinearLayout mStatusIconsKeyguard;

    private NotificationIconAreaController mNotificationIconAreaController;
    private View mNotificationIconAreaInner;
    private View mNotificationIconAreaInnerKeyguard;
    private IconMerger mNotificationIconsKeyguard;
    private ImageView mMoreIconKeyguard;

    private BatteryMeterView mBatteryMeterView;
    private BatteryMeterView mBatteryMeterViewKeyguard;
    private BatteryViewGroup mBatteryViewGroup;
    private BatteryViewGroup mBatteryViewGroupKeyguard;
    private TextView mClock;
    private TextView mClockkeyguard;
    ...
    private View mStatusBarViewKeyguard;
    ...
    public StatusBarIconController(Context context, View statusBar, ViewGroup keyguardStatusBar,
        ...
        mStatusBarViewKeyguard = keyguardStatusBar;
        mPhoneStatusBar = phoneStatusBar;
        mSystemIconArea = (LinearLayout) statusBar.findViewById(R.id.system_icon_area);
        mStatusIcons = (LinearLayout) statusBar.findViewById(R.id.statusIcons);
        mSignalCluster = (SignalClusterViewYuLong) statusBar.findViewById(R.id.signal_cluster);
        mSignalClusterKeyguard = (SignalClusterViewYuLong) mStatusBarViewKeyguard.findViewById(R.id.signal_cluster);

        mNotificationIconAreaController = SystemUIFactory.getInstance()
                .createNotificationIconAreaController(context, phoneStatusBar, keyguardStatusBar);
        ...
        mNotificationIconAreaInnerKeyguard =
                mNotificationIconAreaController.getNotificationInnerAreaViewKeyguard();
        ViewGroup notificationIconAreaKeyguard =
                (ViewGroup) keyguardStatusBar.findViewById(R.id.notification_icon_area_keyguard);
        
        mNotificationIconsKeyguard =
                (IconMerger) mNotificationIconAreaInnerKeyguard.findViewById(R.id.notificationIcons_keyguard);
        mMoreIconKeyguard = (ImageView) mNotificationIconAreaInnerKeyguard.findViewById(R.id.moreIcon_keyguard);
        
        
        mStatusIconsKeyguard = (LinearLayout) keyguardStatusBar.findViewById(R.id.statusIcons);

        mBatteryViewGroup = (BatteryViewGroup) statusBar.findViewById(R.id.battery_field);
        mBatteryViewGroupKeyguard = (BatteryViewGroup) keyguardStatusBar.findViewById(R.id.battery_field);
        mBatteryMeterView = (BatteryMeterView) statusBar.findViewById(R.id.battery);
        mBatteryMeterViewKeyguard = (BatteryMeterView) keyguardStatusBar.findViewById(R.id.battery);
        scaleBatteryMeterViews(context);

        mClock = (TextView) statusBar.findViewById(R.id.clock);
        mClockkeyguard = (TextView) mStatusBarViewKeyguard.findViewById(R.id.clock);
    ...
    public void setSignalCluster(SignalClusterViewYuLong signalCluster) {
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        for (int i = 0; i < mStatusIcons.getChildCount(); i++) {
        	Log.d("","onTuningChanged i="+i+" pkg="+((StatusBarIconView) mStatusIcons.getChildAt(i)).getPackage()+
        			" slot="+((StatusBarIconView) mStatusIcons.getChildAt(i)).getSlot());
        ...
        if(true){
        	ArrayList<StatusBarIconView> viewskeyguard = new ArrayList<StatusBarIconView>();
        	// Get all the current views.
            for (int i = 0; i < mStatusIconsKeyguard.getChildCount(); i++) {
            	viewskeyguard.add((StatusBarIconView) mStatusIconsKeyguard.getChildAt(i));
            }
            // Remove all the icons.
            for (int i = viewskeyguard.size() - 1; i >= 0; i--) {
                removeIcon(viewskeyguard.get(i).getSlot());
            }
            // Add them all back
            for (int i = 0; i < viewskeyguard.size(); i++) {
                setIcon(viewskeyguard.get(i).getSlot(), viewskeyguard.get(i).getStatusBarIcon());
            }
        }
    }
    ...
    private void addSystemIcon(int index, StatusBarIcon icon) {
        ...
        StatusBarIconView view = new StatusBarIconView(mContext, null, icon.pkg, slot, null, blocked);
        view.set(icon);
        view.setRightIcon(true);
        ...
        if(true){
        	StatusBarIconView viewKeyguard = new StatusBarIconView(mContext, null, icon.pkg, slot, null, blocked);
        	viewKeyguard.set(icon);
        	viewKeyguard.setRightIcon(true);
            
            LinearLayout.LayoutParams lpKeyguard = new LinearLayout.LayoutParams(
                    ViewGroup.LayoutParams.WRAP_CONTENT, mIconSize);
            lpKeyguard.setMargins(mIconHPadding, 0, mIconHPadding, 0);
            Log.d("","addSystemIcon: "+" pkg="+icon.pkg+
        			" slot="+slot);
            mStatusIconsKeyguard.addView(viewKeyguard, viewIndex, lpKeyguard);
        }
    ...
    public void updateNotificationIcons(NotificationData notificationData) {
        ...
        //mNotificationIconAreaControllerKeyguard.updateNotificationIcons(notificationData);
    }
    ...
    public void hideNotificationIconArea(boolean animate) {
        animateHide(mNotificationIconAreaInner, false);
        animateHide(mNotificationIconAreaInnerKeyguard, false);
    }

    public void showNotificationIconArea(boolean animate) {
        animateShow(mNotificationIconAreaInner, false);
        animateShow(mNotificationIconAreaInnerKeyguard, false);
    }
    ...
    public void setIconsDarkArea(Rect darkArea) {
        ...
        //mNotificationIconAreaControllerKeyguard.setTintArea(darkArea);
    }
...
//    	animate = false;
    ...
    private void setIconTintInternal(float darkIntensity) {
        ...
        //mNotificationIconAreaControllerKeyguard.setIconTint(mIconTint);
        applyIconTint();
    }
	...
	protected void applyDarkIntensity(float darkIntensity, View lightIcon,
			View darkIcon) {
	...
	private void updateNetSpeedColor() {
		if (mStatusBarView == null)
			return;
		TextView view = (TextView) mStatusBarView
				.findViewById(R.id.text_status_net_speed);
		if (view != null) {
			//setTint(view, StatusBarIconController.getTint(mTintArea, view, mIconTint));
			view.setTextColor(StatusBarIconController.getTint(mTintArea, view, mIconTint));
		}
	}

	private void updateHdVoiceColor() {
		if (mStatusBarView == null)
			return;
		ImageView view = (ImageView) mStatusBarView
				.findViewById(R.id.hd_voice_on);
		if (view != null) {
			setTint(view, StatusBarIconController.getTint(mTintArea, view, mIconTint));
		}
	}

	private void updateVpnFooterColor() {
		if (mStatusBarView == null)
			return;
		ImageView view = (ImageView) mStatusBarView
				.findViewById(R.id.image_vpn_footer);
		if (view != null) {
			setTint(view, StatusBarIconController.getTint(mTintArea, view, mIconTint));
		}
	}
	
	private void updateNetSpeedColorKeyguard() {
		if (mStatusBarViewKeyguard == null)
			return;
		TextView view = (TextView) mStatusBarViewKeyguard
				.findViewById(R.id.text_status_net_speed);
		if (view != null) {
			view.setTextColor(mPhoneStatusBar.getStatusBarIconColorKeyguard());
		}
	}

	private void updateHdVoiceColorKeyguard() {
		if (mStatusBarView == null)
			return;
		ImageView view = (ImageView) mStatusBarViewKeyguard
				.findViewById(R.id.hd_voice_on);
		if (view != null) {
			view.setImageTintList(ColorStateList.valueOf(mPhoneStatusBar.getStatusBarIconColorKeyguard()));
		}
	}

	private void updateVpnFooterColorKeyguard() {
		if (mStatusBarViewKeyguard == null)
			return;
		ImageView view = (ImageView) mStatusBarViewKeyguard
				.findViewById(R.id.image_vpn_footer);
...
//            v.updateStatusIconColor(getTint(mTintArea, v, mIconTint));
    ...
    public void onDensityOrFontScaleChanged() {
        ...
        //mNotificationIconAreaControllerKeyguard.onDensityOrFontScaleChanged(mContext);
        updateClock();
        for (int i = 0; i < mStatusIcons.getChildCount(); i++) {
	...
	public void applyIconTintKeyguard() {
		for (int i = 0; i < mStatusIconsKeyguard.getChildCount(); i++) {
            StatusBarIconView v = (StatusBarIconView) mStatusIconsKeyguard.getChildAt(i);
            v.updateStatusIconColor(mPhoneStatusBar.getStatusBarIconColorKeyguard());
        }
		if(mSignalClusterKeyguard != null){
			mSignalClusterKeyguard.setIconTint(mPhoneStatusBar.getStatusBarIconColorKeyguard(), mDarkIntensity, mTintArea);
       }
		mBatteryViewGroupKeyguard.setIconTint(mPhoneStatusBar.getStatusBarIconColorKeyguard(), mDarkIntensity, mTintArea);
		mBatteryMeterViewKeyguard.setDarkIntensity(
	                isInArea(mTintArea, mBatteryMeterViewKeyguard) ? mDarkIntensity : 0);
       if(mClockkeyguard != null){
    	   mClockkeyguard.setTextColor(mPhoneStatusBar.getStatusBarIconColorKeyguard());
       }
       updateNetSpeedColorKeyguard();
       updateHdVoiceColorKeyguard();
       updateVpnFooterColorKeyguard();
	}
}
