...
public class CurrentUserTracker extends BroadcastReceiver {
    ...
    private static int mCurrentUserId = 0;//UserHandle.USER_CURRENT;
    private static Context mContext = null;
    public static int getCurrentUserId() {
        return UserHandle.USER_CURRENT;//mCurrentUserId;//-2
    }
 ...
 //             LogHelper.sd(TAG, "Settings.System.getIntForUser getCurrentUserId() = " + getCurrentUserId());
                ret = Settings.System.getIntForUser(mContext.getContentResolver(),name,mCurrentUserId);
            }
            catch(Exception e){
...
//      LogHelper.sd(TAG, "Settings.System.getIntForUser: " + name + " = " + ret);
    ...
    public static void putIntForCurrentUser(String name,int value){
        if(mContext != null){
             Settings.System.putIntForUser(mContext.getContentResolver(),name,value,mCurrentUserId);
...
//          cr.unregisterContentObserver(observer);
    ...
    private CurrentUserTracker(Context context) {
        ...
        LogHelper.sd(TAG, "CurrentUserTracker getCurrentUserId() = " + mCurrentUserId);
    }
	...
	private static void setCurrentUserId(int userId) {
	 ...
	 public static int getCurrentUserIdAquire() {
