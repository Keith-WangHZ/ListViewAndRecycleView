...
//        invalidate();
    ...
    private void initView(Context context) {
        ...
        mBottomGapPortrait = getResources().getDimensionPixelSize(
                R.dimen.notification_stack_bottom_line_portrait);
        mBottomGapLandscape = getResources().getDimensionPixelSize(
                R.dimen.notification_stack_bottom_line_landscape);
...
//        invalidate();
    ...
    private int mBottomGapLandscape;
    private int mBottomGapPortrait;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mCurrentOrientation == Configuration.ORIENTATION_LANDSCAPE){  
        	maxHeight = getHeight() - mBottomGapLandscape;
        }else if(mCurrentOrientation == Configuration.ORIENTATION_PORTRAIT){  
        	maxHeight = getHeight() - mBottomGapPortrait;
        }
		setMaxLayoutHeight(maxHeight);
        //setMaxLayoutHeight(getHeight()-Utilities.dipToPixel(mContext, 100));
        updateContentHeight();
        clampScrollPosition();
...
//        invalidate();
    ...
    public void updateTopPadding(float qsHeight, boolean animate,
        ...
        float start = qsHeight + mNotificationTopPadding;
        ...
        for (Pair<ExpandableNotificationRow, Boolean> eventPair : mHeadsUpChangeAnimations) {
			...
			if (!mIsExpanded && !isHeadsUp) {
                type = row.wasJustClicked()
					...
					// We can otherwise get stuck in there if it was just
					// isolated
			} else {
    ...
    public boolean isNotificationExistVisibleChild(){
    	int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            ExpandableView child = (ExpandableView) getChildAt(i);
...
//          if(mPhoneStatusBar.mShowQuickSettings){
//          	mEmptyShadeView.setVisibility(View.GONE);
//          }
          mEmptyShadeView.setVisibility(View.GONE);//===modify by ty
    	}else{
