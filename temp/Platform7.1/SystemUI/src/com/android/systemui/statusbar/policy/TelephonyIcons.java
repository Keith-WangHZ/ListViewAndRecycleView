...
class TelephonyIcons {
	...
	static final int QS_DATA_ZERO = 0;
        ...
        switch (type) {
            ...
            case TelephonyManager.NETWORK_TYPE_EDGE:
                if (!showAtLeast3G) {
                    mSelectedDataTypeIcon[slot] = mRes.getIdentifier(
                            dataTypeArray[type], null, NS);
                    mSelectedQSDataTypeIcon[slot] = QS_DATA_E[QS_DATA_ZERO];
                    mSelectedDataTypeDesc[slot] = mDataTypeDescriptionArray[type];
            ...
            case TelephonyManager.NETWORK_TYPE_TD_SCDMA:
                ...
                mSelectedDataTypeIcon[slot] = mRes.getIdentifier(
                        dataTypeArray[type], null, NS);
                mSelectedQSDataTypeIcon[slot] = QS_DATA_3G[QS_DATA_ZERO];
                mSelectedDataTypeDesc[slot] = mDataTypeDescriptionArray[type];
            ...
            case TelephonyManager.NETWORK_TYPE_HSPA:
                if (hspaDistinguishable) {
                    ...
                    mSelectedDataTypeIcon[slot] = mRes.getIdentifier(
                            dataTypeArray[type], null, NS);
                    mSelectedQSDataTypeIcon[slot] = QS_DATA_H[QS_DATA_ZERO];
                    mSelectedDataTypeDesc[slot] = mDataTypeDescriptionArray[type];
            ...
            case TelephonyManager.NETWORK_TYPE_CDMA:
                if (!showAtLeast3G) {
                    ...
                    mSelectedDataTypeIcon[slot] = mRes.getIdentifier(
                            dataTypeArray[type], null, NS);
                    mSelectedQSDataTypeIcon[slot] = QS_DATA_1X[QS_DATA_ZERO];
                    mSelectedDataTypeDesc[slot] = mDataTypeDescriptionArray[type];
            ...
            case TelephonyManager.NETWORK_TYPE_LTE_CA:
                if (show4GforLte) {
                    ...
                    mSelectedQSDataTypeIcon[slot] = QS_DATA_4G[QS_DATA_ZERO];
                    ...
                    mSelectedDataTypeIcon[slot] = mRes.getIdentifier(
                            dataTypeArray[type], null, NS);
                    mSelectedQSDataTypeIcon[slot] = QS_DATA_LTE[QS_DATA_ZERO];
                    mSelectedDataTypeDesc[slot] = mDataTypeDescriptionArray[type];
                    mSelectedSignalStreagthIndex[slot] = SIGNAL_STRENGTH_TYPE_4G;
                }
                break;
            ...
            case TelephonyManager.NETWORK_TYPE_GSM:
                if (!showAtLeast3G) {
                    ...
                    mSelectedDataTypeIcon[slot] = mRes.getIdentifier(
                            dataTypeArray[type], null, NS);
                    mSelectedQSDataTypeIcon[slot] = QS_DATA_G[QS_DATA_ZERO];
                    mSelectedDataTypeDesc[slot] = mDataTypeDescriptionArray[type];
    ...
    static int getDataTypeDesc(int slot) {//===modify by ty
    	try {
    ...
    static final MobileIconGroup THREE_G = new MobileIconGroup(
            ...
            true,
            TelephonyIcons.QS_DATA_3G[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup E = new MobileIconGroup(
            ...
            false,
            TelephonyIcons.QS_DATA_E[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup ONE_X = new MobileIconGroup(
            ...
            true,
            TelephonyIcons.QS_DATA_1X[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup G = new MobileIconGroup(
            ...
            false,
            TelephonyIcons.QS_DATA_G[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup H = new MobileIconGroup(
            ...
            false,
            TelephonyIcons.QS_DATA_H[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup FOUR_G = new MobileIconGroup(
            ...
            true,
            TelephonyIcons.QS_DATA_4G[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup LTE = new MobileIconGroup(
            ...
            true,
            TelephonyIcons.QS_DATA_LTE[QS_DATA_ZERO]
            );
    ...
    static final MobileIconGroup ROAMING = new MobileIconGroup(
            ...
            false,
            TelephonyIcons.QS_DATA_R[QS_DATA_ZERO]
            );
