...
public class AccessPointControllerImpl
    ...
    private static final int[] ICONS = {
        ...
        R.drawable.stat_sys_wifi_icon_0,
        R.drawable.stat_sys_wifi_icon_1,
        R.drawable.stat_sys_wifi_icon_2,
        R.drawable.stat_sys_wifi_icon_3,
        R.drawable.stat_sys_wifi_icon_4,
    };
    ...
    public boolean connect(AccessPoint ap) {
        ...
        if (ap.isSaved()) {
            ...
            if (ap.getSecurity() != AccessPoint.SECURITY_NONE) {
                ...
                if(qsl != null){
                	QSBottomPanel mQSBottomPanel = qsl.getQSPanel();
                    if(mQSBottomPanel != null){
