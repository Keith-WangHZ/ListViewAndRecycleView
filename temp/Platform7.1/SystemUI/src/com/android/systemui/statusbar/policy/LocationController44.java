...
public class LocationController44 extends BroadcastReceiver {
    ...
    public LocationController44(Context context) {
        mContext = context;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        LogHelper.sd(TAG,  "action = " + action + " enabled = " + enabled);
        boolean visible;
        ...
        if (action.equals(LocationManager.GPS_FIX_CHANGE_ACTION) && enabled) {
            ...
            iconId = R.drawable.stat_sys_gps_on;
            ...
            textContent = mContext.getText(R.string.gps_notification_searching_text_content).toString();
            visible = true;
        }
        ...
        try {
            if (visible) {
                ...
                Notification n = new Notification.Builder(mContext)
                    .setSmallIcon(iconId)
                    .setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), R.drawable.stat_sys_gps))
