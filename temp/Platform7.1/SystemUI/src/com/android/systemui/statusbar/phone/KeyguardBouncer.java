...
public class KeyguardBouncer {
    ...
    public void show(boolean resetSecuritySelection) {
		show(resetSecuritySelection, KeyguardHostView.POSITION_NORMAL);
	}

    public void show(boolean resetSecuritySelection, int position) {
        ...
        ensureView();
        mKeyguardView.setCurrentPosition(position);
