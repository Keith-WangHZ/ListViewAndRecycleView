...
public class LockscreenWallpaper extends IWallpaperManagerCallback.Stub implements Runnable {
    ...
    public Bitmap getBitmapDefaultForKeyguard() {
    	Bitmap bmDefault = null;
    	try {
			Method method = WallpaperManager.class.getDeclaredMethod("getKeyguardBitmap");
			method.setAccessible(true);
			bmDefault = (Bitmap) method.invoke(mWallpaperManager);
		} catch (Exception e) {
			Log.v(TAG, "get keyguard bitmap error: " + e);
			bmDefault = mWallpaperManager.getBitmap();
		}
    	mCache = bmDefault;
    	return mCache;
	}
        ...
        if (fd != null) {
            ...
            if (selectedUser != null && selectedUser.getIdentifier() != currentUserId) {
            	...
            	try {
        			Method method = WallpaperManager.class.getDeclaredMethod("getKeyguardBitmap");
        			method.setAccessible(true);
        			bm = (Bitmap) method.invoke(mWallpaperManager);
        		} catch (Exception e) {
        			Log.v(TAG, "get keyguard bitmap error: " + e);
        			bm = mWallpaperManager.getBitmap();
        		}
            	/*Bitmap bm = mWallpaperManager.getBitmap();
            	int flag  = 0;
            	if(bm != null){
            		int w = bm.getWidth();
            		int h = bm.getHeight();
                ...
                return LoaderResult.success(bm);//
            }
        }
    }
	...
	@Override
	public void onLauncherMenuWallpaperChanged() throws RemoteException {
		// TODO Auto-generated method stub
	}
