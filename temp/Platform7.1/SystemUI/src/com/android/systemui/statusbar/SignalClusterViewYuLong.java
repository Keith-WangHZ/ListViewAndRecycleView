...
public class SignalClusterViewYuLong
    ...
    private static final int MAX_PHONE_COUNT = 2;
    ...
    private MultiSignalView[] mSignalView = new MultiSignalView [MAX_PHONE_COUNT];

    private int [] mSignalIconId = new int [MAX_PHONE_COUNT];
    private int [] mSignalSlaveIconId = new int [MAX_PHONE_COUNT];
    private int [] mSignalTypeIconId = new int [MAX_PHONE_COUNT];
    private int [] mSignalSlaveTypeIconId = new int [MAX_PHONE_COUNT];
    private int [] mSignalBackIconId = new int [MAX_PHONE_COUNT];
...
//        }              
	...
	public void setSignalIndicators(int phoneId, int strengthIcon, int typeIcon) {
		...
		if (phoneId >= 0 && phoneId < MAX_PHONE_COUNT) {
