...
public class LocationControllerImpl extends BroadcastReceiver implements LocationController {
    ...
    private LocationController44 mLocation44;
    public LocationControllerImpl(Context context, Looper bgLooper) {
        mContext = context;
        mLocation44 = new LocationController44(context);
    ...
    private void refreshViews() {
    	if(mLocation44 != null)
    		return;
    	LogHelper.sd("LocationControllerImpl", "LocationControllerImpl refreshViews mAreActiveLocationRequests:" + mAreActiveLocationRequests);
