        ...
        try {
            ...
            parser.parse(new File("system/lib/uitechno/cfg.xml"), new DefaultHandler() {
                ...
                public void startElement(String uri, String localName,
                    ...
                    if(LogHelper.NOLOGGING)LogHelper.sd(TAG, "localName = " + localName 
...
//        return new NetworkController(mContext);
    ...
    private void CreateShortcutList(ArrayList<Integer>  mShortcutList, String mShortcutFromXml, 
    	...
    	String shortcutDef;// = "0,1,19,9,13,5,37,8,6,12,14,7,2,15,17,10";////"2,0,1,8,5,9,13,19,37,6,7,14,12,15,17,43";
    	...
    	if(!isPrimay){
    		shortcutDef = "2,0,1,8,5,9,13,22,11,6,7,14,12,15,42,43";//"0,1,8,13,6,5,37,2,7";
    		shortcutExcludeDef = "";
    	}else{
    		shortcutDef = "2,0,1,8,5,9,13,22,11,6,7,14,12,15,42,43"/*"0,1,8,13,9,5,37,2,6,16"*/;
    		shortcutExcludeDef = "";
    	}
