...
public class FingerprintUnlockController extends KeyguardUpdateMonitorCallback {
    ...
    public void onFingerprintAuthenticated(int userId) {
        ...
        mMode = calculateMode();
        Log.d("fingerWakeupSlowLog:", "wasDeviceInteractive = " + wasDeviceInteractive + ", mMode = " + mMode);
        ...
        switch (mMode) {
            case MODE_DISMISS_BOUNCER:
            	Log.d("fingerWakeupSlowLog:", "MODE_DISMISS_BOUNCER");
                mStatusBarKeyguardViewManager.notifyKeyguardAuthenticated(
                        false /* strongAuth */);
                break;
            case MODE_UNLOCK:
            case MODE_SHOW_BOUNCER:
            	Log.d("fingerWakeupSlowLog:", "MODE_UNLOCK");
                if (!wasDeviceInteractive) {
...
//                        FINGERPRINT_COLLAPSE_SPEEDUP_FACTOR);
            ...
            case MODE_WAKE_AND_UNLOCK_PULSING:
            	Log.d("fingerWakeupSlowLog:", "MODE_WAKE_AND_UNLOCK_PULSING");
                mPhoneStatusBar.updateMediaMetaData(false /* metaDataChanged */, 
                        true /* allowEnterAnimation */);
                // Fall through.
            case MODE_WAKE_AND_UNLOCK:
            	Log.d("fingerWakeupSlowLog:", "MODE_WAKE_AND_UNLOCK");
                mStatusBarWindowManager.setStatusBarFocusable(false);
                mDozeScrimController.abortPulsing();
                mKeyguardViewMediator.onWakeAndUnlocking();
                mScrimController.setWakeAndUnlocking();
    ...
    public void onFingerprintError(int msgId, String errString) {
		...
		if(mUpdateMonitor.shouldWakeUpForFingerprint()){
