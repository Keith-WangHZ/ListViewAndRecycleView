...
//        }
    ...
    protected void onFinishInflate() {
        ...
        mTopLine = findViewById(R.id.notification_row_line_top);
        mBottomLine = findViewById(R.id.notification_row_line_bottom_fix);
...
//        }
    ...
    public void updateBackgroundForGroupState() {
        ...
        if (mChildrenContainer != null) {
            mChildrenContainer.setChildrenExpanded(isGroupExpanded());
        }
    }
