...
//                        com.android.internal.R.dimen.text_size_small_material));
    ...
    private void updateCameraVisibility() {
        ...
        ResolveInfo resolved = resolveCameraIntent();
        		boolean visible = !isCurrentUserAirlock() && !isCameraDisabledByDpm() && resolved != null
                && getResources().getBoolean(R.bool.config_keyguardShowCameraAffordance)
                && mUserSetupComplete;
        mCameraImageView.setVisibility(visible ? View.VISIBLE : View.GONE);
    }
    
	private boolean isCurrentUserAirlock() {
		//ANROID_712_UPDATE: modify by ty on 20170221 for android7.1 update
		/*try {
			final int userId = ActivityManagerNative.getDefault().getCurrentUser().id;
			return userId == UserHandle.USER_AIRLOCK;
    ...
    private boolean canLaunchVoiceAssist() {
    	return mAssistManager.canVoiceAssistBeLaunchedFromKeyguard() && !isCurrentUserAirlock();
    }
