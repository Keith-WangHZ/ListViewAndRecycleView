...
import com.android.keyguard.CoolUITextClock;
...
public class KeyguardIndicationController {
	...
	private String inVisibleOwnerInfo;
...
//        setRestingIndication(getOwnerInfo());
        setRestingIndication(inVisibleOwnerInfo);
    }
    ...
    public void showTransientIndication(String transientIndication) {
        showTransientIndication(transientIndication, computeColor());
    }
	...
	private int computeColor() {
		...
		return KeyguardUpdateMonitor.getInstance(mContext).isDarkerColor() ? CoolUITextClock.KEYGUARD_CLOCK_COLOR_BLACK
				: CoolUITextClock.KEYGUARD_CLOCK_COLOR_WHITE;
	}
    ...
    KeyguardUpdateMonitorCallback mUpdateMonitor = new KeyguardUpdateMonitorCallback() {
        ...
        public void onFingerprintError(int msgId, String errString) {
    		...
    		if (msgId == FingerprintManager.FINGERPRINT_ERROR_LOCKOUT) {
    			errString = mContext.getResources().getString(R.string.fingerprint_error_lockout);
    		}
            int errorColor = mContext.getResources().getColor(R.color.system_warning_color, null);
            if (mStatusBarKeyguardViewManager.isBouncerShowing()) {
