...
public class MyPreferenceCategory extends Preference {
	private ImageView iv_perference_icon;
	 private TextView title, summary;
	 private int mClickCounter=0;//R.drawable.notification_preview_other;
	...
	public final void setImageResource(int bg){
		mClickCounter = bg;
		LogHelper.sd("MyPreferenceCategory", "bg="+bg);
	...
	protected void onBindView(View view) {
		...
		iv_perference_icon = (ImageView) view.findViewById(R.id.imagePrev);
		if (iv_perference_icon != null) {
			if(mClickCounter>0)iv_perference_icon.setImageResource(mClickCounter);
        }
	}
