...
public class SystemUIFactory {
    ...
    public static void createFromConfig(Context context) {
        final String clsName = "com.android.systemui.SystemUIFactory";//context.getString(R.string.config_systemUIFactoryComponent);
    ...
    public NotificationIconAreaController createNotificationIconAreaController(Context context,
            PhoneStatusBar phoneStatusBar, ViewGroup keyguardStatusBar) {
        return new NotificationIconAreaController(context, phoneStatusBar, keyguardStatusBar);
    }
