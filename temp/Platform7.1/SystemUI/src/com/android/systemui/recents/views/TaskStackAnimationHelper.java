...
public class TaskStackAnimationHelper {
    ...
    public void startDeleteTaskAnimation(final TaskView deleteTaskView,
            final ReferenceCountedTrigger postAnimationTrigger) {
        final TaskStackViewTouchHandler touchHandler = mStackView.getTouchHandler();
...
//            int startDelay = taskIndexFromFront * DOUBLE_FRAME_OFFSET_MS;
            ...
            AnimationProps taskAnimation = new AnimationProps(/*startDelay*/0,
                    /*DISMISS_ALL_TASKS_DURATION*/0, DISMISS_ALL_TRANSLATION_INTERPOLATOR,
                    new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
                    postAnimationTrigger.decrement();
