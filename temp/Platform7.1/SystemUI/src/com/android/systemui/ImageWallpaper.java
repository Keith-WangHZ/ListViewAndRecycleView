...
public class ImageWallpaper extends WallpaperService {
    ...
    class DrawableEngine extends Engine {
        ...
        private DisplayInfo getDefaultDisplayInfo() {//10*31ms
        	if(mTmpDisplayInfo == null){
        ...
        private boolean drawWallpaperWithOpenGL(SurfaceHolder sh, int w, int h, int left, int top) {
            ...
            boolean status = mEgl.eglSwapBuffers(mEglDisplay, mEglSurface);//94mss
            checkEglError();
        ...
        private int loadTexture(Bitmap bitmap) {
            ...
            GLUtils.texImage2D(GL_TEXTURE_2D, 0, GL_RGBA, bitmap, GL_UNSIGNED_BYTE, 0);//61mss
            checkGlError();
        ...
        private boolean initGL(SurfaceHolder surfaceHolder) {
            ...
            mEglContext = createContext(mEgl, mEglDisplay, mEglConfig);//2*25mss
            ...
            mEglSurface = mEgl.eglCreateWindowSurface(mEglDisplay, mEglConfig, surfaceHolder, null);//2*50mss
