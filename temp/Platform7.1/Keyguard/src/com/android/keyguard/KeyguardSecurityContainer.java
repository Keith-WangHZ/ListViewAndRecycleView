...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    private View dialogView = new TextView(mContext);
    ...
    final CountDownTimer timer= new CountDownTimer(30000,1000) {
	    ...
	    public void onTick(long arg0) {
	        ...
	        if(mDialog!=null){
	        	mDialog.setMessage(mContext.getString(getTimeOutMessageId(),  KeyguardUpdateMonitor.getInstance(mContext).getFailedUnlockAttempts(
	                    KeyguardUpdateMonitor.getCurrentUser()), thetime));
	        }
	    }
    ...
    public void startResetAppearAnimation(float startTranslationY, Runnable resetRunnable) {
        if (mCurrentSecuritySelection != SecurityMode.None) {
            getSecurityView(mCurrentSecuritySelection).startResetAppearAnimation(startTranslationY, resetRunnable);
            setTranslationY(0);
        }
    }
    ...
    private void showDialogCountDownTimer(String title, String message, int messageId) {
    	mTimeOutMessageId = messageId;
	...
	private int getTimeOutMessageId() {
		return mTimeOutMessageId;
	}
...
//            showDialog(null, message);
            showDialogCountDownTimer(null, message, messageId);
        }
    }
    ...
    protected int getLayoutIdFor(SecurityMode securityMode) {
        switch (securityMode) {
            ...
            return KeyguardUpdateMonitor.isSupportOversea() || KeyguardUpdateMonitor.isCTSInstalled()
					? R.layout.keyguard_pin_view : R.layout.coolui_pin_view;
