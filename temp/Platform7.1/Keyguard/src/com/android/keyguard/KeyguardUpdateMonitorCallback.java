...
public class KeyguardUpdateMonitorCallback {
    ...
    /**
     * Called when the hall sensor state changed
     * @param state
    ...
    /**
     * Called when the weather data changed
     * @param weatherData
     * @add by mengludong 2015.11.09
     */
	...
	/**
     * Called when antitheft state changed
     * @param showing
	...
	/**
     * Called when roaming state changed
     * @add by mengludong 2015.12.01
     */
	public void onRoamingStateChange(boolean isNetWorkRoaming) { }

	/**
     * Called when cool show theme changed
     * @add by mengludong 2015.12.01
     */
	public void onCoolShowThemeChanged(String path, boolean reload, boolean isVlifeTheme) { }

	public void onUpdateKeyguardTextColor(boolean darkerColor) { }
	
	public void onShowNumChanged(String packageName, int num) { }
}
