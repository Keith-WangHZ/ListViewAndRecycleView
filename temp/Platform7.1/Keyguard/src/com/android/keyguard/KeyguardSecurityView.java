...
public interface KeyguardSecurityView {
    ...
    /**
     * Starts the animation which should run when reset to keyguard form the security view.
     */
    void startResetAppearAnimation(float startTranslationY, Runnable resetrRunnable);
