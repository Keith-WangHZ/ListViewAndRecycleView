...
public class KeyguardSimPinView extends KeyguardPinBasedInputView {
    ...
    private AlertDialog mSimPinUnlockAlertDialog;
    ...
    public void resetState() {
        ...
        if (DEBUG) Log.v(TAG, "Resetting state, mSubId = " + mSubId);
    ...
    private Dialog getSimPinUnlockAlertDialog() {
		String msg = mContext.getResources().getString(R.string.kg_sim_pin_unlock_succeed);
        if (mSimPinUnlockAlertDialog == null) {
            Builder builder = new AlertDialog.Builder(mContext);
            builder.setMessage(msg);
            builder.setCancelable(false);
            builder.setNeutralButton(R.string.ok, null);
            mSimPinUnlockAlertDialog = builder.create();
            mSimPinUnlockAlertDialog.getWindow().setType(
                    WindowManager.LayoutParams.TYPE_KEYGUARD_DIALOG);
        } else {
        	mSimPinUnlockAlertDialog.setMessage(msg);
        }
        return mSimPinUnlockAlertDialog;
    }
                    ...
                    post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (result == PhoneConstants.PIN_RESULT_SUCCESS) {
                                ...
                                getSimPinUnlockAlertDialog().show();
                            } else {
	...
	@Override
	public void startResetAppearAnimation(float startTranslationY, Runnable resetrRunnable) {
