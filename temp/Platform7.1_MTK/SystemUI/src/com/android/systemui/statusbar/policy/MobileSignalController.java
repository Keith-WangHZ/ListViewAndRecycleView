...
public class MobileSignalController extends SignalController<
    ...
    private boolean isImsRegisteredInWifi() {
        ...
        if (subInfos != null) {
            for (SubscriptionInfo subInfo: subInfos) {
                ...
                /// M modify for MTK
                if (mPhone != null && ((mPhone.isWifiCallingAvailable() && mPhone.isVolteAvailable()) ||
                		(mPhone.isWifiCallingAvailable() && mPhone.isVideoTelephonyAvailable()))
    ...
    private int getImsIconId() {
        ...
        //wrong show for MTK, just for qualcom
...
//        if (subId != null && subId.length >= 1) {/// M modify for MTK
...
//        }
        String networkClass = "";//getNetworkClassString(mServiceState);/// M modify for MTK
    ...
    private void generateIconGroup() {
        ...
        if (dataType == TelephonyManager.NETWORK_TYPE_IWLAN &&
            ...
            qsDataTypeIcon = TelephonyIcons.QS_DATA_4G[0];
        ...
        if (roaming) {
            ...
            qsDataTypeIcon = TelephonyIcons.QS_DATA_R[0];
        }
        if (DEBUG) {
    ...
    private int getImsRadioTechnology() {
        ...
        return mServiceState.getRilDataRadioTechnology();/// M modify for MTK, wrong showing here
