...
public class SignalClusterView
    ...
    protected int mWifiStrengthId = 0;
	protected int mWifiActivityId = 0;
    ...
    protected String mWifiDescription;
    ...
    private void maybeScaleVpnAndNoSimsIcons() {
        ...
        if(mVpn != null)mVpn.setImageDrawable(new ScalingDrawableWrapper(mVpn.getDrawable(), mIconScaleFactor));

        if(mNoSims != null)mNoSims.setImageDrawable(
                new ScalingDrawableWrapper(mNoSims.getDrawable(), mIconScaleFactor));
        if(mNoSimsDark != null)mNoSimsDark.setImageDrawable(
    ...
    protected void onAttachedToWindow() {
        ...
        for (PhoneState state : mPhoneStates) {
        	if(mMobileSignalGroup != null)mMobileSignalGroup.addView(state.mMobileGroup);
        }
    ...
    protected void onDetachedFromWindow() {
        ...
        if(mMobileSignalGroup != null)mMobileSignalGroup.removeAllViews();
    ...
    private boolean getImsOverWifiStatus(int subId) {
      ...
      /// M modify for MTK
        if (tm != null && ((tm.isWifiCallingAvailable() && tm.isVolteAvailable()) ||
        		(tm.isWifiCallingAvailable() && tm.isVideoTelephonyAvailable()))
    ...
    protected PhoneState getState(int subId) {
        for (PhoneState state : mPhoneStates) {
    ...
    protected int getWifiActivityId(boolean activityIn, boolean activityOut) {
        if (!getContext().getResources().getBoolean(R.bool.config_showWifiActivity)) {
            return 0;
        }
        int activityId = 0;
        if (activityIn && activityOut) {
            activityId = R.drawable.stat_sys_wifi_datainout;//R.drawable.stat_sys_wifi_inout;
        } else if (activityIn) {
            activityId = R.drawable.stat_sys_wifi_datain;//R.drawable.stat_sys_wifi_in;
        } else if (activityOut) {
            activityId = R.drawable.stat_sys_wifi_dataout;//R.drawable.stat_sys_wifi_out;
        }
        return activityId;
    }
    ...
    private void apply() {
        ...
        mWifiSignalSpacer =           findViewById(R.id.wifi_signal_spacer);
        mMobileSignalGroup = (LinearLayout) findViewById(R.id.mobile_signal_group);
		if (mVpn == null || mEthernetGroup == null || mEthernet == null
				|| mEthernetDark == null || mWifiGroup == null || mWifi == null
				|| mWifiDark == null || mWifiActivity == null
				|| mAirplane == null || mNoSims == null || mNoSimsDark == null
				|| mNoSimsCombo == null || mWifiAirplaneSpacer == null
				|| mWifiSignalSpacer == null || mMobileSignalGroup == null) {
        	return;
        }
