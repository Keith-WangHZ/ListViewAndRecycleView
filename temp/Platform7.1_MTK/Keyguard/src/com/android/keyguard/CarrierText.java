...
public class CarrierText extends TextView {
    ...
    private static CharSequence mSeparatorForOneCarrier;
    ...
    /// M modify for MTK
    private  static final int phoneId=TelephonyManager.getDefault().getPhoneCount() ;
    ...
    public CarrierText(Context context, AttributeSet attrs) {
        super(context, attrs);
        mIsEmergencyCallCapable = false/*context.getResources().getBoolean(
    ...
    */
    ...
    protected void updateCarrierText() {
        ...
        //set showLocale equal false to Sync 6.0 logic
        boolean showLocale = false/*true*/;/*getContext().getResources().getBoolean(
...
//            CharSequence networkClass = "";
            ...
            boolean showRat = false/*SubscriptionManager.getResourcesForSubId(mContext,
...
//                        }
            ...
            if (carrierTextForSimState != null) {
              ...
              /// M modify for MTK
                displayText = concatenate(displayText, carrierTextForSimState, null);
       ...
       /* if (N < TelephonyManager.getDefault().getPhoneCount() &&
        ...
        if (allSimsMissing) {
        	CharSequence msm = getContext().getText(R.string.keyguard_missing_sim_message_short);
            if (N != 0) {
				...
				displayText = concatenate(msm, msm);
				
				/// M modify for MTK
            	if(phoneId>2){
				displayText = concatenate(msm, msm , msm);
            	}
                ...
                if (i != null) {
                    ...
                    if (Objects.equals(plmn, spn)) {
                    	...
                    	/// M modify for MTK
                        text = concatenate(plmn, spn, null);
                    }
                }
                /*displayText =  makeCarrierStringOnEmergencyCapable(
...
//        displayText = updateCarrierTextWithSimIoError(displayText, allSimsMissing);
    ...
    protected void onFinishInflate() {
        ...
        mSeparatorForOneCarrier = getResources().getString(
                com.android.internal.R.string.kg_text_message_separator);
        mSeparator = getContext().getString(R.string.text_message_separator);
  ...
  /// M modify for MTK
	private static CharSequence concatenate(CharSequence plmn, CharSequence spn,CharSequence spmn) {
        final boolean plmnValid = !TextUtils.isEmpty(plmn);
        final boolean spnValid = !TextUtils.isEmpty(spn);
        final boolean spmnValid = !TextUtils.isEmpty(spmn);
        if (plmnValid && spnValid&&spmnValid) {
            return new StringBuilder().append(plmn).append(mSeparator).append(spn).append(mSeparator).append(spmn).toString();
        } else if (plmnValid && spnValid) {
            return new StringBuilder().append(plmn).append(mSeparator).append(spn).toString();
        } else if (plmnValid && spmnValid) {
            return new StringBuilder().append(plmn).append(mSeparator).append(spmn).toString();
        } else if (spnValid&&spmnValid) {
            return new StringBuilder().append(spn).append(mSeparator).append(spmn).toString();
        } else if (plmnValid) {
            return plmn;
        } else if (spnValid) {
            return spn;
